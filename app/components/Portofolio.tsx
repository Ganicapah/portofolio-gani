      ...
      <div ref={containerRef} className="relative">
        ...
        <div className="flex flex-col md:flex-row relative z-20 mt-12 md:mt-0">
          ...
          <div className="w-full md:w-2/3 pl-14 md:pl-12 pb-16">
            <p className="text-gray-400 mb-8 leading-relaxed text-sm md:text-base">
              Engineered a scalable backend system using Node.js and MySQL to
              automate cash flow records, replacing the village&apos;s manual
              bookkeeping. Designed robust database schemas and RESTful APIs for
              real-time profit and loss monitoring, optimizing both time and
              space complexity to ensure stability as financial data grows.
            </p>
            <div className="bg-[#1a1a1a] rounded-xl overflow-hidden mb-6 aspect-video relative group cursor-pointer border border-gray-800 hover:border-gray-600 transition-colors">
              <a
                href="https://www.bumdesa-pekiringan.com"
              ...
              >
                <Image
                  src="/bumdes.png"
                  alt="BUMDes Financial Management System Project"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  priority
                  className="object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100"
